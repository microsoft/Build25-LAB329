"""
Unit tests for distill_gpt4o.py main script.
"""
import unittest
...
from src.distill_gpt4o import parse_args, main

class TestDistillGPT4o(unittest.TestCase):
    def test_parse_args_default(self):
        """Test argument parsing with default values."""
        # Test with no arguments
        with patch('sys.argv', ['distill_gpt4o.py']):
            args = parse_args()
    ...
    @patch('src.distill_gpt4o.initialize_openai_client')
    @patch('src.distill_gpt4o.create_sample_prompts')
    @patch('src.distill_gpt4o.generate_training_examples')
    @patch('src.distill_gpt4o.save_examples_to_jsonl')
    @patch('src.distill_gpt4o.get_ml_client')
    @patch('src.distill_gpt4o.register_dataset')
    @patch('src.distill_gpt4o.create_distillation_job')
    @patch('src.distill_gpt4o.load_dotenv')
    def test_main_successful_flow(self, mock_load_dotenv, mock_create_job, 
        ...
        with patch('sys.argv', ['distill_gpt4o.py', '--num_examples', '10']):
            # Call the function
            main()
